...
public class Symbol {
    ...
    /** Arreglo: siempre "inicializado" — la declaración reserva el espacio. El tipo almacenado es el tipo del elemento. */
    public static Symbol arreglo(String nombre, String tipoElemento, int linea, int columna) {
        return new Symbol(nombre, tipoElemento, Categoria.ARREGLO, true, linea, columna);
    }
